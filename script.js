...
const translations = {
    ...
    es: {
        ...
        about_p1: 'Somos un equipo apasionado de creadores digitales que transformamos ideas de negocio en experiencias digitales impactantes. Nos especializamos en crear sitios web rápidos, modernos y responsivos que no solo se ven increíbles, sino que también <strong>convierten visitantes en clientes</strong>.',
    ...
    pt: {
        ...
        about_p1: 'Somos uma equipe apaixonada de criadores digitais que transforma ideias de negócios em experiências digitais incríveis. Especializamo-nos na criação de sites rápidos, modernos e responsivos que não apenas parecem incríveis, mas também <strong>convertem visitantes em clientes</strong>.',
        ...
        svc5_desc: 'Transformamos seu site desatualizado em uma experiência moderna, rápida e responsiva para celular que impressiona.',
